"""
Test for cisco.meraki.devices_camera_sense using fixture cisco.meraki.devices_camera_sense.json
Method: updateDeviceCameraSense
"""
import jq


def test_cisco_meraki_devices_camera_sense_updateDeviceCameraSense(query_data, load_fixture):
    """Test query execution for cisco.meraki.devices_camera_sense (updateDeviceCameraSense)."""
    module_fqcn = "cisco.meraki.devices_camera_sense"
    method_name = "updateDeviceCameraSense"
