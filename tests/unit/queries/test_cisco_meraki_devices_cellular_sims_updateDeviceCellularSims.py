"""
Test for cisco.meraki.devices_cellular_sims using fixture cisco.meraki.devices_cellular_sims.json
Method: updateDeviceCellularSims
"""
import jq


def test_cisco_meraki_devices_cellular_sims_updateDeviceCellularSims(query_data, load_fixture):
    """Test query execution for cisco.meraki.devices_cellular_sims (updateDeviceCellularSims)."""
    module_fqcn = "cisco.meraki.devices_cellular_sims"
    method_name = "updateDeviceCellularSims"
